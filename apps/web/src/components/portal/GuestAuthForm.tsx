...
export function GuestAuthForm({ next = "/" }: { next?: string }) {
  ...
  return (
    <div className="guest-shell min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center bg-white px-10 rounded-2xl mb-4 shadow-sm">
